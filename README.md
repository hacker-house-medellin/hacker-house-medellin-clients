# hacker-house-medellin-clients (superseded)

> This repository is frozen. The canonical source of truth is [`hhm-clients`](https://github.com/hacker-house-medellin/hhm-clients).
...
- Open issues, pull requests, releases, and new work in `hacker-house-medellin/hhm-clients`.
- Change Zed dependencies to `"hacker-house-medellin/hhm-clients" = "^0.1.0"`.
- Point any retained submodule at `hacker-house-medellin/hhm-clients` and classify it according to the canonical monorepo's composition policy.
